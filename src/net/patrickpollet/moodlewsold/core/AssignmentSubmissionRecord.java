...
public class AssignmentSubmissionRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private net.patrickpollet.moodlewsold.core.FileRecord[] files;
     ...
     * @return files
     */
    public net.patrickpollet.moodlewsold.core.FileRecord[] getFiles() {
        return files;
    }
     ...
     * @param files
     */
    public void setFiles(net.patrickpollet.moodlewsold.core.FileRecord[] files) {
        this.files = files;
