...
public class UserRecord  extends SoapObject  implements Soapeabilisable{
    ...
    private net.patrickpollet.moodlews.core.ProfileitemRecord[] profile;
     ...
     * @return profile
     */
    public net.patrickpollet.moodlews.core.ProfileitemRecord[] getProfile() {
        return profile;
    }
     ...
     * @param profile
     */
    public void setProfile(net.patrickpollet.moodlews.core.ProfileitemRecord[] profile) {
